...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.clearing = {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.clearing', 'ul[' + this.attr_name() + '] li',
          function (e, current, target) {
            ...
            self.openDialog(image, current, target);
    ...
    openDialog : function ($image, current, target) {
      var self = this,
          body = $(document.body),
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.dropdown = {
    ...
    events : function (scope) {
      ...
      S(this.scope)
        ...
        .on('mouseenter.fndtn.dropdown', '[' + this.attr_name() + '], [' + this.attr_name() + '-content]', function (e) {
          ...
          if (settings.is_hover) self.openDialog.apply(self, [dropdown, target]);
        })
    ...
    openDialog: function (dropdown, target) {
        this
          .css(dropdown
    ...
    toggle : function (target) {
      ...
      if (dropdown.hasClass(this.settings.active_class)) {
        ...
        this.openDialog.call(this, dropdown, target);
      }
    },
  ...
  Foundation.libs.reveal = {
    ...
    events : function (scope) {
        ...
        .on('click.fndtn.reveal', '[' + this.add_namespace('data-reveal-id') + ']', function (e) {
          ...
          if (!self.locked) {
            ...
            if (typeof ajax === 'undefined') {
              self.openDialog.call(self, element);
            } else {
              var url = ajax === true ? element.attr('href') : ajax;

              self.openDialog.call(self, element, {url: url});
            }
          }
        });
      ...
      if(S('[' + self.attr_name() + ']', this.scope).length > 0) {
        S(this.scope)
          // .off('.reveal')
          .on('open.fndtn.reveal', this.settings.openDialog)
        ...
        S(this.scope)
          // .off('.reveal')
          .on('open.fndtn.reveal', '[' + self.attr_name() + ']', this.settings.openDialog)
    ...
    openDialog : function (target, ajax_settings) {
      var self = this;
      if (target) {
      ...
      if (!modal.hasClass('open')) {
        ...
        if (typeof ajax_settings === 'undefined' || !ajax_settings.url) {
          ...
          this.show(modal, settings.css.openDialog);
        } else {
          ...
          $.extend(ajax_settings, {
            success: function (data, textStatus, jqXHR) {
              ...
              self.show(modal, settings.css.openDialog);
            }
          });
